...
parcels <- as.tibble(parcel_select)
head(parcel)
...
# loadl in package
UseCodes<-read_delim("UseCodes.csv", delim = "|", na = "No Description Available", col_types = cols_only(UseCode = "n", CodeDesc = "c"))
...
parcels$UseCode <- as.numeric(parcels$UseCode)
# Join
